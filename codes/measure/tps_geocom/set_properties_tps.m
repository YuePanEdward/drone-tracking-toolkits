function set_properties_tps(TPSport, prism_type, target_type, atr_state, hz_tol, v_tol)
% set_properties_tps: set the neccessary parameters for total station
% measurements
% By Yue Pan @ ETHZ IGP
% For details, please check GeoCOM mannual
